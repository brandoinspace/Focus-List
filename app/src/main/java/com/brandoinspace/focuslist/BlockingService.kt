...
const val FOCUS_LIST = "com.brandoinspace.focuslist"
        ...
        when (intent?.action) {
            ...
            Actions.BREAK_IS_FINISHED.toString(), Actions.CANCEL_BREAK.toString() -> {
                if (BREAK_ALARM_INTENT != null) {
                    ...
                    val notification =
                        NotificationCompat.Builder(this, "focus_list_break_over_channel")
            ...
            Actions.REQUEST_BREAK.toString() -> {
                ...
                ShortcutManagerCompat.disableShortcuts(
                    this,
                    listOf("request_break"),
                    R.string.break_cooldown_shortcut_disabled.toString()
                )
                val alarm = getSystemService(ALARM_SERVICE) as AlarmManager
                val breakTime =
                    intent.getIntExtra("break_time_minutes_extra", BREAK_TIME_DEFAULT) * 60_000L
                val cooldownTime = intent.getIntExtra(
            ...
            Actions.COOLDOWN_IS_FINISHED.toString() -> {
                if (COOLDOWN_ALARM_INTENT != null) {
                    ...
                    val pending =
                        PendingIntent.getActivity(this, 0, openIntent, PendingIntent.FLAG_IMMUTABLE)
                    val notification =
                        NotificationCompat.Builder(this, "focus_list_cooldown_break_over_channel")
                            .setSmallIcon(R.drawable.notification_icon)
                            ...
                            },
                            {
                                Intent(this@BlockingService, BlockingService::class.java)
                                    .putExtra(
                                        ...
                                        current.value[BREAK_TIME] ?: BREAK_TIME_DEFAULT
                                    )
                                    .putExtra(
                                        "cooldown_time_minutes_extra_request",
                                        current.value[BREAK_COOLDOWN] ?: BREAK_COOLDOWN_DEFAULT
                                    )
                                    .also {
