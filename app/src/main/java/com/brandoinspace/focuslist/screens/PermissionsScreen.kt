...
import com.brandoinspace.focuslist.ACCESSIBILITY_ENABLED
import com.brandoinspace.focuslist.alerts.DisplayAccessibilityDialog
import com.brandoinspace.focuslist.alerts.DisplayAlarmPermissionDialog
import com.brandoinspace.focuslist.alerts.DisplayBatteryPermissionDialog
import com.brandoinspace.focuslist.alerts.DisplayOverPermissionDialog
import com.brandoinspace.focuslist.alerts.NotificationPermissionDialog
import com.brandoinspace.focuslist.getActivityOrNull
            ...
            LazyColumn(Modifier
                ...
                item {
                    Row(Modifier.clickable {
                        Log.d("focus", "clicked")
                        val isGranted =
                            powerManager.isIgnoringBatteryOptimizations(current.packageName)
                        val activity = current.getActivityOrNull()
                        if (activity != null) {
                            if (!isGranted) {
