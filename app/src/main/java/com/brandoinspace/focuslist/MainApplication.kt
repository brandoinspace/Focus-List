...
class MainApplication : Application() {
    override fun onCreate() {
        ...
        val blockingChannel = NotificationChannel(
            ...
            group = blockingGroup
            description =
                "The notification that is sent to let you know that the Blocking service has begun."
        }
        val breakChannel = NotificationChannel(
            ...
            group = breakGroup
            description =
                "The notification that is sent when your break is over and the app will be blocked again."
        }
        val cooldownBreakChannel = NotificationChannel(
            ...
            group = breakGroup
            description =
                "The notification that is sent when your break cooldown is over and you can take another break."
        }
